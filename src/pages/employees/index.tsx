...
export function EmployeeListPage(props: EmployeeListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getEmployees({
        relations: ['user', 'company', 'attendance.count', 'department.count', 'project.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('attendance', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.attendance,
        }
      : null,
    hasAccess('department', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'department',
          header: 'Department',
          accessorKey: 'department',
          cell: ({ row: { original: record } }: any) => record?._count?.department,
        }
      : null,
