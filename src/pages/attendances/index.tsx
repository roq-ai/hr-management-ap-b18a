...
export function AttendanceListPage(props: AttendanceListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    },
    {
      ...
      accessorKey: 'time_in',
      cell: ({ row: { original: record } }: any) =>
        record?.time_in ? format(parseISO(record?.time_in as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'time_out',
      header: 'Time Out',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.time_out ? format(parseISO(record?.time_out as unknown as string), 'dd-MM-yyyy') : '',
    },
    { id: 'hours_worked', header: 'hours_worked', accessorKey: 'hours_worked' },
    { id: 'overtime', header: 'overtime', accessorKey: 'overtime' },
