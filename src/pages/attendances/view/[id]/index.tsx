            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('attendance', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/attendances/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem
                  label="Time In"
                  text={data?.time_in ? format(parseISO(data?.time_in as unknown as string), 'dd-MM-yyyy') : ''}
                />

                <FormListItem
                  label="Time Out"
                  text={data?.time_out ? format(parseISO(data?.time_out as unknown as string), 'dd-MM-yyyy') : ''}
                />

                <FormListItem label="Hours Worked" text={data?.hours_worked} />

                <FormListItem label="Overtime" text={data?.overtime} />
